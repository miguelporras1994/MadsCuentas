<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CargarCuentasContabilidad.aspx.cs" EnableEventValidation="false" Inherits="CargarCuentasContabilidad" MasterPageFile="~/MasterPage.master" %>
        ...
        <td  colspan="4">
            <asp:GridView AutoGenerateColumns ="False" 
                 ...
                 <Columns >
                     ...
                     <asp:BoundField  DataField="FECHA_CREACION" HeaderText="FECHA DE CREACION" Visible="true"  >                
                     </asp:BoundField>
                     <asp:BoundField  DataField="DEPENDENCIA" HeaderText="DEPENDENCIA" Visible="false"  >                
                     </asp:BoundField>
                     <asp:BoundField  DataField="CDP" HeaderText="CDP" Visible="true"  >                
                     </asp:BoundField>
                     <asp:BoundField  DataField="COMPROMISO" HeaderText="COMPROMISO" Visible="true"  >                
                     </asp:BoundField>
                     ...
                     <asp:BoundField  DataField="VALOR_ACTUAL" ItemStyle-Width="150px"  Visible="true" HeaderText="VALOR ACTUAL" DataFormatString="{0:C}"  >                
                     </asp:BoundField>

                     <asp:BoundField  DataField="FECHA_REGISTRO" HeaderText="FECHA REGISTRO"  Visible="true"  >                
                     </asp:BoundField>

                     <asp:BoundField  DataField="FECHA_CREACION" HeaderText="FECHA CREACION" Visible="true"  >
                     </asp:BoundField>           

                     <asp:BoundField  DataField="VALOR_DEDUCCIONES"  Visible="false"  >                
                     </asp:BoundField>
