<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ListarCuentasPorPagar.aspx.cs" Inherits="ListarCuentasPorPagar" MasterPageFile="~/MasterPage.master" %>
...
<ControlStyle CssClass="thickbox"></ControlStyle>
                ...
                <asp:HyperLinkField DataNavigateUrlFields="ID_REGISTRO" Target="_self" DataNavigateUrlFormatString="CuentaPorPagar.aspx?editar=true&id={0}" Text="Editar" />
