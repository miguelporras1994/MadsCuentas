<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ListarPendientesAdjuntosRadicados.aspx.cs" Inherits="ListarPendientesAdjuntosRadicados" MasterPageFile="~/MasterPage.master" %>
                ...
                <td>
                    ...
                    <table style="width: 75%;">
                        ...
                        <tr>
                            <td>&nbsp;</td>
                            <td>
                                <label for="Correo Electronico">Radiados hoy:</label><asp:CheckBox ID="CheckBoxRadicadosHoy" runat="server" Checked="True" />
                            </td>
                            <td style="width: 70px">&nbsp;</td>
                            <td><label for="Correo Electronico">Sin Adjuntos:</label>
                                <asp:CheckBox ID="CheckBoxSinAdjuntos" runat="server" />
                            </td>
                            <td style="width: 26px">&nbsp;</td>
                            <td>
                                &nbsp;</td>
                        ...
                        <tr>
                            ...
                            <td style="width: 26px; height: 82px;">
...
<ControlStyle CssClass="thickbox"></ControlStyle>
                ...
                <asp:BoundField DataField="NUM_PAGO" HeaderText="NUMERO PAGO" >
                    <ItemStyle Width="300px"></ItemStyle>
                </asp:BoundField>
                ...
                <asp:HyperLinkField DataNavigateUrlFields="ID_REGISTRO" Target="_self" DataNavigateUrlFormatString="RadicadosAdjuntar.aspx?id={0}" Text="Adjuntar" />
