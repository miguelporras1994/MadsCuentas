    ...
    protected void Login_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            else
            {
                ...
                System.Web.UI.ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "AlertBox", "alert('Por favor verifique su usuario y contraseña o contacte al administrador.');", true);
