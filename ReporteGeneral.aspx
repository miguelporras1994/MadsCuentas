        ...
        <table style="width:100%;">
                    ...
                    <asp:Image ID="Image1" runat="server" ImageUrl="~/images/excel_icon.png" Width="60px" /><asp:Button ID="ButtonGenerarReporte" runat="server" CssClass="btn-success btn-lg" OnClick="ButtonGenerarReporte_Click" Text="Descargar Reporte" />
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:TextBox ID="TextBoxRadicado" CssClass="form-control" runat="server"></asp:TextBox></td>
                            <td style="width: 70px"></td>
                            <td>
            ...
            <tr>
                <td>
                   ...
                   <asp:GridView ID="GridView1" AllowPaging="true" AllowSorting="true" PageSize="40" AutoGenerateColumns="False" OnPageIndexChanging="GridView1_PageIndexChanging" runat="server" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" EnableModelValidation="True" GridLines="Vertical">
                ...
                <asp:BoundField DataField="NUM_PAGO" HeaderText="NUM PAGO" >
                ...
                <asp:BoundField DataField="REPORTE_OBLIGACION" HeaderText="OB" />
                <asp:BoundField DataField="ENTIDAD" HeaderText="ENTIDAD" />
                <asp:BoundField DataField="ESTADO" HeaderText="ESTADO" />
                
                <asp:HyperLinkField Visible="true" DataNavigateUrlFields="ID_REGISTRO" Target="_blank" DataNavigateUrlFormatString="OrdenPagoMADS.aspx?id={0}" Text="Deducciones" />
                <asp:HyperLinkField Visible="true" DataNavigateUrlFields="ID_REGISTRO" Target="_blank" DataNavigateUrlFormatString="LiquidacionPDF.aspx?id={0}" Text="Detalle Liquidacion" />
