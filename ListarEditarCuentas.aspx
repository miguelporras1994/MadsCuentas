<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ListarEditarCuentas.aspx.cs" Inherits="ListarEditarCuentas" MasterPageFile="~/MasterPage.master" %>
        ...
        <table style="width:100%;">
            ...
            <tr>
                <td>
                   ...
                   <asp:GridView ID="GridView1" OnPageIndexChanging="GridView1_PageIndexChanging" AllowPaging="True" AllowSorting="True" PageSize="40" AutoGenerateColumns="False" runat="server" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" EnableModelValidation="True" GridLines="Vertical">
...
<ControlStyle CssClass="thickbox"></ControlStyle>
                ...
                <asp:HyperLinkField DataNavigateUrlFields="ID_REGISTRO" Target="_self" DataNavigateUrlFormatString="Radicacion.aspx?editar=true&id={0}" Text="Editar" />
           ...
           <tr>
                <td>
                        ...
                        <div style ="height:700px; width:1180px; overflow:auto;">
                            ...
                            <HeaderTemplate>
                <table id="example" cellpadding="1" cellspacing="0" 
            ...
            <ItemTemplate>
                <tr>
                  <td><%# Eval("ID_REGISTRO") %></td>
                  <td><%# Eval("NOMBRE_BENEFICIARIO") %></td>
                </tr>
            </ItemTemplate>
            <FooterTemplate>
                    </tbody>
