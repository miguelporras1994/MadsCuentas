<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ListarPendientesLiquidar.aspx.cs" Inherits="ListarPendientesLiquidar" MasterPageFile="~/MasterPage.master" %>
...
<ControlStyle CssClass="thickbox"></ControlStyle>
                ...
                <asp:HyperLinkField  DataNavigateUrlFields="ID_REGISTRO" Target="_blank" DataNavigateUrlFormatString="LiquidacionPDF.aspx?id={0}" Text="Liquidacion" />
                <asp:HyperLinkField DataNavigateUrlFields="ID_REGISTRO" Target="_self" DataNavigateUrlFormatString="WebFormLiquidacion.aspx?id={0}" Text="Liquidar" />
                <asp:HyperLinkField DataNavigateUrlFields="ID_REGISTRO" Target="_self" DataNavigateUrlFormatString="DevolverCuenta.aspx?id={0}&Fuente=IngresoCuentePorPagar&Formulario=ListarPendientesLiquidar.aspx" Text="Devolver" />
