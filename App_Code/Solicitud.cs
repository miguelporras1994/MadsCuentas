...
public class Solicitud
{
    ...
    public Solicitud(int id_registro)
    {
    ...
    public int insertar()
    {
        ...
        try
        {
            using (DbConnection conn = conBD.GetDatabaseConnection())
            {
                ...
                SqlCommand cmd = new SqlCommand("INSERTAR_SOLICITUD", (SqlConnection)conn);
    ...
    public int aprobada(string observaciones)
    {
        ...
        try
        {
            using (DbConnection conn = conBD.GetDatabaseConnection())
            {
                ...
                string sql = "UPDATE SOLICITUD SET ESTADO = 2, OBSERVACIONES_APROBACION = @OBSERVACIONES WHERE ID_ADQUISICION = @ID_ADQUISICION";
    ...
    public int rechazada(string observaciones)
    {
        ...
        try
        {
            using (DbConnection conn = conBD.GetDatabaseConnection())
            {
                ...
                string sql = "UPDATE SOLICITUD SET ESTADO = 3, OBSERVACIONES_APROBACION = @OBSERVACIONES WHERE ID_ADQUISICION = @ID_ADQUISICION";
                SqlCommand cmd = new SqlCommand(sql, (SqlConnection)conn);
