<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CuentaPorPagar.aspx.cs" Inherits="CuentaPorPagar" MasterPageFile="~/MasterPage.master" %>
...
<div class="panel-heading">Cuenta por pagar</div>
      <div class="panel-body">
                ...
                <table style="width:100%;">
                    <tr>
                        ...
                        <td >
                            <label for="Cuenta por pagar">Cuenta por pagar*:</label>
                            <asp:TextBox CssClass="form-control" ID="TextBoxCuentaPorPagar" Width="150" runat="server"></asp:TextBox>
                            <ajaxToolkit:FilteredTextBoxExtender ID="TextBoxCuentaPorPagar_FilteredTextBoxExtender" 
                    runat="server" FilterType="Numbers" TargetControlID="TextBoxCuentaPorPagar"/>
                
            
               
                
            <asp:RequiredFieldValidator ID="RFV20" runat="server" 
                ControlToValidate="TextBoxCuentaPorPagar" Display="None" 
                ErrorMessage="Por favor ingrese el numero de cuenta por pagar" 
                ...
                runat="server" TargetControlID="RFV20">            </ajaxToolkit:ValidatorCalloutExtender>        
                    ...
                    <tr>
                        ...
                        <td class="auto-style14">
                            ...
                            <asp:DropDownList Width="180" CssClass="form-control" ID="DropDownListEntidad" runat="server" AppendDataBoundItems="True" DataSourceID="SqlDataSourceEntidades" DataTextField="NOMBRE" DataValueField="ID_ENTIDAD">
                    ...
                    <tr>
                        ...
                        <td class="auto-style7">
                            <asp:FileUpload ID="FileUploadAdj" runat="server" Visible="false" /></td>
                        <td class="auto-style4">
