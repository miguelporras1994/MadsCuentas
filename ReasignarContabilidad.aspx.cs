...
public partial class ReasignarContabilidad : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            if (Request.QueryString["id"] != null)
            {
                ...
                ViewState["Formulario"] = "AsignarCuentaContabilidad.aspx";
    ...
    protected void ButtonGuardar_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            int res = cuenta.reasignarContabilidad(DropDownListAsignado.SelectedValue);

            if (res > 0)
            {
                cuenta.insertarLOG(usuario.Alias, "Contabilidad Cuenta reasignada a: " + DropDownListAsignado.Text, "Reasignacion", ViewState["Fuente"].ToString());
