<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ResolverSolicitud.aspx.cs" Inherits="ResolverSolicitud" MasterPageFile="~/MasterPage.master" %>
        ...
        <tr>
            <td >
                ...
                <table style="width:111%;"  >
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="TextBoxNumRegistro" runat="server"></asp:TextBox>
                
            
                
                        </td>
                        <td __designer:mapid="20c">
                            <asp:Label ID="LabelError" runat="server" ForeColor="Red">Ingrese el numero de registro</asp:Label>
                        </td>
            ...
            <ajaxToolkit:FilteredTextBoxExtender
                        ID="TextBoxHHContratistaOnShore_FilteredTextBoxExtender" runat="server" 
                            ...
                            <asp:DropDownList ID="DropDownListDuracion" runat="server" Enabled="False" DataSourceID="SqlDataSource7" DataTextField="NOMBRE" DataValueField="ID_DURACION">
                ...
                <table style="width:100%;">
                    <tr>
                        ...
                        <td class="auto-style10">
                            <asp:DropDownList ID="DropDownListAprobacion" runat="server" AppendDataBoundItems="True" DataSourceID="SqlDataSourceAprobacion" DataTextField="NOMBRE" DataValueField="ID_ESTADO">
                                <asp:ListItem Value="0">--Seleccionar--</asp:ListItem>
                            </asp:DropDownList>
                            <asp:SqlDataSource ID="SqlDataSourceAprobacion" runat="server" ConnectionString="<%$ ConnectionStrings:bd_con_adq %>" SelectCommand="SELECT [ID_ESTADO], [NOMBRE] FROM [ESTADO] WHERE ([ID_ESTADO] &lt;&gt; @ID_ESTADO)">
                                <SelectParameters>
                                    <asp:Parameter DefaultValue="1" Name="ID_ESTADO" Type="Int32" />
                                </SelectParameters>
                            </asp:SqlDataSource>
                            <asp:RangeValidator ID="RangeValidator15" runat="server" ControlToValidate="DropDownListAprobacion" Display="None" ErrorMessage="Por favor seleccione" MaximumValue="99999" MinimumValue="1" SetFocusOnError="True"></asp:RangeValidator>
                            <ajaxToolkit:ValidatorCalloutExtender ID="RangeValidator15_ValidatorCalloutExtender" runat="server" TargetControlID="RangeValidator15">
