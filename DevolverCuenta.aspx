<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DevolverCuenta.aspx.cs" Inherits="DevolverCuenta" MasterPageFile="~/MasterPage.master" %>
...
PopupControlID="UpdateProgress" BackgroundCssClass="modalPopup" />
 ...
 <ContentTemplate>
    ...
    <table style="width:100%;" align="center">
        ...
        <tr>
            <td class="titulo1">
                Devoluci&oacute;n de Cuenta</td>
        </tr>
        <tr>
            <td >
                &nbsp;</td>
      ...
      <div class="panel-body">
                <table style="width:60%;">
                    <tr>
                        ...
                        <td class="auto-style10"><label for="Devolver a">Devolver a*:</label>
                            <asp:DropDownList ID="DropDownListGrupoDevolucion" CssClass="form-control " Width="150" runat="server" AppendDataBoundItems="True" DataSourceID="SqlDataSourceGrupoDevolucion" DataTextField="NOMBRE" DataValueField="ID_GRUPO_DEVOLUCION" AutoPostBack="True">
                ...
                runat="server" TargetControlID="RFV22">            </ajaxToolkit:ValidatorCalloutExtender>        
                    ...
                    <tr>
                        <td class="auto-style8">
                            &nbsp;</td>
                        <td class="auto-style7">
                            <asp:Label ID="LabelNotificacion" runat="server" Text="Enviar notificacion al contratista:" Visible="False" Font-Bold="True" /><asp:CheckBox ID="CheckBoxNotificacion" runat="server" Visible="False" />
                        </td>
                    </tr>
                    </table>
                </div>
        ...
        <tr>
            <td class="style2" align="center">
                <asp:Button ID="ButtonGuardar" runat="server" CssClass="btn-success btn-lg" Text="Registrar Devolucion" OnClick="ButtonGuardar_Click" />
                </td>
        </tr>
        <tr>
            <td >
