<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ListarCuentasEliminarCXP.aspx.cs" Inherits="ListarCuentasEliminarCXP" MasterPageFile="~/MasterPage.master" %>
...
<ControlStyle CssClass="thickbox"></ControlStyle>
                ...
                <asp:HyperLinkField DataNavigateUrlFields="ID_REGISTRO" Target="_self" DataNavigateUrlFormatString="EliminarCuentaPorPagar.aspx?Formulario=ListarCuentasEliminarCXP.aspx&id={0}" Text="Eliminar CxP" />
