...
public partial class ReasignarTesoreria : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            if (Request.QueryString["id"] != null)
            {
                ...
                ViewState["Formulario"] = "AsignarCuentaTesoreria.aspx";
    ...
    protected void ButtonGuardar_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            int res = cuenta.reasignarTesoreria(DropDownListAsignado.SelectedValue);

            if (res > 0)
            {
                cuenta.insertarLOG(usuario.Alias, "Tesoreria Cuenta reasignada a: " + DropDownListAsignado.Text, "Reasignacion", ViewState["Fuente"].ToString());
