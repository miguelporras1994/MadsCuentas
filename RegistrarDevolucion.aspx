<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RegistrarDevolucion.aspx.cs" Inherits="RegistrarDevolucion" MasterPageFile="~/MasterPage.master" %>
...
<ControlStyle CssClass="thickbox"></ControlStyle>
                ...
                <asp:HyperLinkField DataNavigateUrlFields="ID_REGISTRO" Target="_self" DataNavigateUrlFormatString="DevolverCuenta.aspx?id={0}&Fuente=IngresoCuentePorPagar&Formulario=RegistrarDevolucion.aspx" Text="Devolver" />
                <asp:HyperLinkField DataNavigateUrlFields="ID_REGISTRO" Target="_self" DataNavigateUrlFormatString="AnularCuenta.aspx?id={0}&Fuente=IngresoCuentePorPagar&Formulario=RegistrarDevolucion.aspx" Text="Anular" />
