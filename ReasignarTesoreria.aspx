<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReasignarTesoreria.aspx.cs" Inherits="ReasignarTesoreria" MasterPageFile="~/MasterPage.master" %>
                ...
                <table style="width:60%;">
                    <tr>
                        ...
                        <td class="auto-style10">
                            ...
                            <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:bd_con %>" SelectCommand="SELECT [USUARIO], NOMBRE + ' (' + CAST(dbo.CuentasAsignadasTesoreria(USUARIO) AS VARCHAR(10)) + ')' AS NOMBRE FROM [USUARIOS] WHERE [PERFIL] IN ('Tesoreria','TesoreriaLider') ORDER BY [NOMBRE]">
                                <SelectParameters>
                                    <asp:Parameter DefaultValue="Tesoreria" Name="PERFIL" Type="String" />
                                </SelectParameters>
                            </asp:SqlDataSource>
                        </td>
                    </tr>
